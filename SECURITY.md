...
Only the latest official public release (see
[sky.melloo.me/mellooessentials](https://sky.melloo.me/mellooessentials)) and the current `main`
branch are supported. Older releases and self-built/test versions are not.
...
This covers the MellooEssentials mod (this repository) and the sky.melloo.me website/API. Third-party
