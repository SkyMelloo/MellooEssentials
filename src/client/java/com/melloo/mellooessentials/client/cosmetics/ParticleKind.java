...
public enum ParticleKind {
	...
	LARGE_SMOKE("Large Smoke", ParticleTypes.LARGE_SMOKE),
	EXPLOSION("Explosion", ParticleTypes.EXPLOSION),
	WITCH("Witch", ParticleTypes.WITCH),
	CRIT("Crit", ParticleTypes.CRIT),
	ANGRY_VILLAGER("Angry Villager", ParticleTypes.ANGRY_VILLAGER),
	PORTAL("Portal", ParticleTypes.PORTAL),
	GLOW("Glow", ParticleTypes.GLOW),
	GUST("Gust", ParticleTypes.GUST),
	SONIC_BOOM("Sonic Boom", ParticleTypes.SONIC_BOOM),
	SQUID_INK("Squid Ink", ParticleTypes.SQUID_INK),
	GLOW_SQUID_INK("Glow Squid Ink", ParticleTypes.GLOW_SQUID_INK),
	SCRAPE("Scrape", ParticleTypes.SCRAPE),
	WAX("Wax", ParticleTypes.WAX_ON),
	TRIAL_OMEN("Trial Omen", ParticleTypes.TRIAL_OMEN),
