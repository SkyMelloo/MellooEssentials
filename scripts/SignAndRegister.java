...
public class SignAndRegister {
    public static void main(String[] args) {
        try {
            ...
            Path keyFile = Paths.get(System.getProperty("user.home"), ".mellooessentials-signing", "private_key.pem");
            ...
            Path tokenFile = Paths.get(System.getProperty("user.home"), ".mellooessentials-signing", "build_report_token.txt");
